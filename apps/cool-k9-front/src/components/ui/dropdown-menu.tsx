...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        // Base — matches ghost button: rounded, text-sm, transitions
        "relative flex cursor-pointer select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none transition-colors",
        // Disabled
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        // Inset
        inset && "pl-8",
        // Default hover/focus — matches ghost button hover:bg-accent hover:text-accent-foreground
        variant === "default" && "focus:bg-accent focus:text-accent-foreground",
        // Destructive — text-destructive, hover gives light red background
